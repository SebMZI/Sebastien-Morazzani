    ...
    <AnimatePresence mode="wait">
      ...
      >
        <section className="mb-20">
          <h1 className="text-ascent font-extrabold uppercase">
          ...
          <p>
            ...
            <br />
            Morazzani-Marigny Sébastien, inscrite sous le numéro 983 044 306,
            dont le siège social est situé au 6 Les Rives de l`Acheneau, 44710
            Port Saint Père. (Ci-après désigné le « Vendeur »). <br /> Le Site
            est hébergé par la société Vercel Inc., situé 440 N Barranca Ave
            #4133 Covina, CA 91723, (email :{" "}
            <Link className="text-ascent" href={"privacy@vercel.com"}>
              privacy@vercel.com
            </Link>
            ). <br /> Le Directeur de la publication du Site est
            Morazzani-Marigny Sébastien. Le Service Client du Prestataire peut
            être contacté : par email en vous adressant à{" "}
            <Link
          ...
          <p>
            ...
            <span className="text-ascent">Conditions Générales</span> ») ont
            pour objet de définir et de régir les rapports contractuels entre le
            Prestataire et tout professionnel (un «{" "}
            <span className="text-ascent">Client</span> ») désirant bénéficier
            des services proposés par Sébastien Morazzani-Marigny.
            <br />
            <br /> La fourniture des services proposés aux Clients est
            conditionnée à l’acceptation préalable sans restriction ni réserve
            des présentes Conditions Générales. Les Conditions Générales sont
            mises à la disposition des Clients sur le Site ou au dos du devis où
            ...
            stipulation contraire figurant dans tous documents émanant du
            Client, et notamment dans ses conditions générales d’achat. <br />
            <br />
            Les Conditions Générales sont applicables sous réserve de toute
            stipulation contraire figurant au bon de commande ou à des
            conditions particulières le cas échéant conclues entre la Société et
            le Client concerné.
          </p>
          ...
          <p>
            ...
            Cette liste de services n`est pas exhaustive. Les Tarifs et
            modalités de prestations des services peuvent varier en focntion des
            besoins du Clients.
          </p>
          ...
          <p>
            ...
            <br /> -       signer le devis;
            <br /> -       payer un acompte de 30% du montant total du devis
            (Voir Art. 5);
          ...
          <p>
            ...
            pas modifier sa commande après l`avoir validée, laquelle sera ferme
            et définitive.
          </p>
          <br />
          <p>
            En passant commande, le Client accepte expressément que le
          ...
          <p>
            Les Services sont fournis au tarif du Prestataire en vigueur fau
            jour de la commande, exprimé en euros hors taxes, TTC.
          </p>
          <br />
          <p>
          ...
          <br />
          <p>
            Le tarif est ferme et ne peut être révisé pendant la durée
            d’exécution des Services, les parties renonçant expressément à se
          ...
          <p>
            ...
            tout moment pour tous Services qui seraient souscrits
          ...
          <p>
            ...
            comme un défaut de paiement et entraînera toutes les conséquences
          ...
          <p>
            ...
            l`obligation, conformément aux dispositions de l`article 1344 du
            Code civil. En cas de retard de paiement de l’une quelconque des
            échéances, le Prestataire se réserve notamment le droit, sans
            qu’aucune indemnité ne soit due au Client, de : <br /> <br /> -
                  exiger le paiement immédiat de l’ensemble des sommes à devoir
            au titre des Services, celles-ci devenant immédiatement exigibles
            quelle que soit leur échéance initialement prévue ; <br /> -
                   refuser toute nouvelle commande ou exiger pour toute nouvelle
            commande un paiement comptant ou une garantie pour la bonne
            exécution des engagements ; <br /> -       imputer tout paiement
            partiel en premier lieu sur la partie non privilégiée de la créance
            puis sur les sommes dont l`exigibilité est la plus ancienne ; <br />{" "}
            -       réduire, suspendre ou annuler l’accès aux Services, 14 jours
            après mise en demeure restée sans effet, effectuée par le
            Prestataire auprès du Client ; <br /> -       appliquer, sans mise
            en demeure préalable, à toutes les sommes dues, dès le premier jour
            de retard et jusqu`à complet paiement, des pénalités de retard
            calculées au taux visé à l’article L.441-6 du Code de Commerce ;{" "}
            <br /> et/ou -       exiger le paiement d’une indemnité forfaitaire
            de 40 € pour frais de recouvrement, pour chaque facture payée en
            retard, sans préjudice de la réparation de tout dommage
            effectivement subi.
          </p>
          <br />
          <p>
          ...
          <p>
            Le Client reconnaît expressément que toute commande effectuée est
            une commande avec obligation de paiement, qui nécessite le paiement
            d’un prix contre la fourniture du Service commandé.
          </p>
          <p>
            Les commandes peuvent être payées en ayant recours à l’un des modes
            de paiement suivants :<br />
            <br /> ●           Paiement par carte bancaire. Le paiement
            s`effectue directement sur les serveurs bancaires sécurisés de la
            banque du Prestataire, les coordonnées bancaires du Client ne
            transitent pas sur le Site. Les coordonnées bancaires communiquées
            lors du paiement sont protégées par un procédé de cryptage SSL
            (Secure Socket Layer). Les cartes bancaires émises par des banques
            domiciliées hors de France doivent obligatoirement être des cartes
            bancaires internationales. Le paiement via ces cartes bancaires
            s`effectue au comptant, sans escompte
            <br />
          ...
          <p>
            ...
            ses obligations en vertu des présentes Conditions Générales, ainsi
            que de toute autre documentation conclue avec les Clients, tout en
            respectant les dispositions législatives et réglementaires en
            vigueur ainsi que les droits de tiers.
          </p>
          <br />
          <p>
            Le Prestataire déclare posséder les compétences, l`expérience et les
            ressources nécessaires pour fournir les Services de développement
            web, et il assume la pleine responsabilité tant de la prestation des
          ...
          <p>
            ...
            des sites web développés peuvent être temporairement interrompus
            dans certaines situations, notamment en cas de force majeure, de
            dysfonctionnements des équipements ou du réseau internet des
            Clients, de défaillance des opérateurs de télécommunication,
            d`interruption de fourniture d`électricité, d`utilisation anormale,
            illicite ou frauduleuse des sites web par un Client ou un tiers, de
            décision des autorités compétentes, ou pour tout autre motif.
          </p>
          <br />
          <p>
            Le Prestataire se réserve également le droit d`apporter aux sites
            web et aux Services de développement web toutes les modifications et
          ...
          <p>
            ...
            notifiées aux Clients via les sites web avant qu`elles ne
            surviennent, sauf en cas d`urgence.
          </p>
          ...
          <p>
            ...
            détaillées, de contenus, d`accès aux serveurs et aux bases de
            données, ainsi que toute autre information pertinente.
          </p>
          <br />
          <p>
            ...
            retard dans la fourniture de ces informations peut entraîner un
            délai supplémentaire dans la réalisation des Services de
            développement web, et le Client en est informé.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            Services de développement web, conformément aux termes de l`article
            8.
          </p>
          <br />
          <p>
          ...
          <p>
            Les parties s`engagent à faire leurs meilleurs efforts pour parvenir
            à un règlement amiable de la situation dans un délai de trente (30)
            jours calendaires à compter de la notification initiale du Client.
            Le Prestataire s`engage à prendre toutes les mesures nécessaires
            pour remédier à tout défaut ou problème signalé par le Client.
          </p>
          <br />
          <p>
          ...
          <p>
            Le Prestataire est tenu à une obligation de moyens en ce qui
            concerne la fourniture des Services de développement web..
          </p>
          <p>
            Chaque Client reconnaît les contraintes et les limites des réseaux
            Internet et comprend qu`il ne peut pas rechercher la responsabilité
            du Prestataire pour les dysfonctionnements dans l`accès aux
            Services, les vitesses d`ouverture et de consultation des pages des
            Services, l`inaccessibilité temporaire ou permanente des Services,
            ou l`utilisation frauduleuse par des Clients ou des tiers du Site.
          </p>
          <br />
          <p>
            ...
            généralement toute circonstance ou événement empêchant le
            Prestataire d’exécuter convenablement ses obligations;
            <br /> -       Si les informations, données, instructions,
            directives, matériels ou supports communiqués par le Client sont
            erronés ou incomplets, et plus généralement dans le cas où
            l’inexécution ou l’exécution défectueuse des Services résulte en
            tout ou partie du comportement, d’un manquement ou d’une carence du
            Client;
            <br /> -       Si les fonctionnalités du Site s`avèrent
          ...
          <p>
            ...
            mesures techniques pour contourner les mesures de protection mises
            en place par le Prestataire.
          </p>
          <br />
          <p>
          ...
          <br />
          <p>
            En tout état de cause, le Prestataire n`encourt aucune
            responsabilité au titre de tous dommages indirects ou immatériels,
            tels que le préjudice financier, la perte de chance, la perte de
            profit, la perte de contrat, la perte de commande, la perte de
            clientèle, la perte d`exploitation, le préjudice ou trouble
            commercial, ou le préjudice d`image
          </p>
          <br />
          <p>
            {" "}
          ...
          <p>
            ...
            par la prescription à l`expiration d`une durée d`un (1) an suivant
            la date à laquelle le Client concerné a eu connaissance ou est
          ...
          <p>
            ...
            informatiques du Prestataire et de ses partenaires dans des
            conditions raisonnables de sécurité, seront considérés comme les
            preuves des communications et actions des Clients et du Prestataire.
            L’archivage de ces éléments est effectué sur un support fiable et
            durable de manière à correspondre à une copie fidèle et durable au
          ...
          <p>
            ...
            personnelles si vous estimez que leur traitement n`est plus
            nécessaire aux fins pour lesquelles elles ont été collectées ou si
            vous retirez votre consentement. Vous pouvez également demander la
            suppression de vos données si vous vous opposez au traitement, si le
            traitement est illicite ou si nous sommes légalement tenus de le
            faire. Pour exercer votre droit à la suppression de vos données
            personnelles, veuillez nous contacter en utilisant les coordonnées
            fournies: contact@sebastien-morazzani.com. Nous traiterons votre
            demande dans un délai raisonnable conformément aux exigences
            légales.
          </p>
          ...
          <p>
            ...
            en provenance d’un site tiers ou sur le Site vers un site tiers ou
            de partenaire ne saurait engager la responsabilité du Prestataire à
            quelque titre que ce soit et notamment quant à la disponibilité, aux
            contenus et aux produits et/ou services disponibles sur ou à partir
            de ce site tiers ou partenaire.
          </p>
          ...
          <p>
            ...
            les bases de données, les logiciels, et toute autre création
            originale (ci-après désignés collectivement comme les &apos;Éléments
            du Développement Web&apos;), demeureront la propriété exclusive du
            Prestataire.
          </p>
          <br />
          <p>
            Une fois que le paiement intégral des Services de Développement Web
            a été reçu par le Prestataire, tous les droits de propriété
            intellectuelle sur les Éléments du Développement Web seront
            transférés au Client, sous réserve de tout autre accord écrit entre
            les parties
          </p>
          <br />
          <p>
          ...
          <br />
          <p>
            En cas de non-paiement intégral des Services de Développement Web,
            le Prestataire se réserve le droit de révoquer tout droit
            d`utilisation accordé au Client concernant les Éléments du
            Développement Web.
          </p>
          <br />
          <p>
          ...
          <p>
            Les présentes Conditions Générales régissent la prestation de
            services de développement web et sont conclues pour la durée
            nécessaire à l`achèvement de cette prestation, telle que spécifiée
            dans le contrat de prestation de services conclu entre le
            Prestataire et le Client. En cas de vente ponctuelle ou d`accord sur
            une durée spécifique, les Conditions Générales s`appliquent pour la
            période convenue dans le contrat.
          </p>
          <br />
          <p>
            Le Prestataire se réserve le droit de suspendre temporairement ou de
            résilier immédiatement la prestation des Services de Développement
            Web en cas de violation substantielle par le Client de ses
            obligations découlant des présentes Conditions Générales ou en vertu
            des lois et réglementations applicables. Cette suspension ou
            résiliation peut être temporaire ou permanente, selon la gravité du
            manquement.
          </p>
          <br />
          <p>
            Le Prestataire ou le Client peut résilier les présentes Conditions
            Générales de plein droit en envoyant une notification écrite dans
            les situations suivantes :<br />
            <br /> -        En cas de force majeure, comme défini à l`article 10
            ci-avant ;<br /> -        En cas de manquement grave de l`autre
            partie à ses obligations en vertu des présentes Conditions
            Générales, à condition que la partie en faute n`ait pas remédié à ce
            manquement dans un délai de quinze (15) jours (lorsque cela est
            possible) suivant une notification écrite indiquant la nature du
            manquement et la nécessité de le corriger.
          </p>
          ...
          <p>
            Pendant la durée des présentes, chaque partie peut être amenée à
            avoir accès à des informations, des documents et/ou des données
            ...
            agissant en son nom, à maintenir la stricte confidentialité de
            toutes les informations, documents et/ou données confidentiels de
            toute nature relatifs aux résultats, à l`activité ou à la clientèle
            de l`autre partie, ainsi que de toute information reçue ou obtenue
            de l`autre partie dans le cadre de la prestation de services.
          </p>
          <br />
          <p>
            L`engagement de confidentialité des parties demeure en vigueur
            pendant la durée des présentes et continue de s`appliquer pendant
            une période de deux (2) ans suivant leur expiration ou leur
            résiliation.
          </p>
          ...
          <br />
          <p>
            Les communications doivent être adressées aux coordonnées de la
            partie concernée, chaque partie choisissant son domicile au sein de
            son siège social.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            destinataire, attestée par un accusé de réception. Les
            communications envoyées par courrier recommandé avec accusé de
            réception seront réputées avoir été effectuées à la date de la
            première présentation à l`adresse du destinataire. Les
            communications par courrier électronique seront réputées avoir été
            effectuées à la date d`envoi du courrier électronique.
          </p>
          ...
          <p>
            ...
            générales était déclarée nulle ou inapplicable pour quelque cause
            que ce soit en application d`une loi, d`un règlement ou à la suite
            d`une décision de justice devenue définitive, elle serait réputée
          ...
          <h2 className="my-10 font-semibold text-2xl">Article 20 - LITIGES</h2>
          <p>
            Les litiges qui pourront survenir dans le cadre des relations
            contractuelles établies entre le Client et le Prestataire devront
            être résolus, dans la mesure du possible, de manière amiable.
          </p>
          <br />
          <p>
            À défaut de règlement amiable dans un délai d`un mois à compter de
            la saisine de l`une des parties, tous les litiges découlant des
            présentes Conditions Générales, y compris leur validité,
            interprétation, exécution, résiliation, conséquences et suites,
            seront soumis à la compétence exclusive du tribunal de Nantes.
          </p>
          ...
          <br />
          <p>
            Les présentes Conditions Générales sont rédigées en langue
            française. En cas de traduction en une ou plusieurs langues
